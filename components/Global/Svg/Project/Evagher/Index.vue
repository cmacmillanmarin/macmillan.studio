<template>
  <div :class="['svg__project__evagher', { 'svg__project__evagher--animation': animation }]">
    <template v-if="isMobileLayout">
      <Ticker
        ...
        class="svg__project__evagher__ticker"
        @update="emit('update-scroll')">
        <div v-for="i in 2" :key="i">
          <SvgProjectEvagherFirstLine
...
const id = 'project-ticker-evagher'
