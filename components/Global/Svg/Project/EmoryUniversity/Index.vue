<template>
  <div
    :class="[
      'svg__project__emory-university',
      { 'svg__project__emory-university--animation': animation },
    ]">
    <template v-if="isMobileLayout">
      <Ticker
        ...
        class="svg__project__emory-university__ticker"
        @update="emit('update-scroll')">
        <div v-for="i in 2" :key="i">
          <SvgProjectEmoryUniversityFirstLine
      ...
      <Ticker
        ...
        @update="emit('update-scroll')">
        <div v-for="i in 2" :key="i">
          <SvgProjectEmoryUniversitySecondLine
            v-transition:in="{ callback: animation ? shuffleIn : () => {} }" />
        </div>
      </Ticker>
    </template>
