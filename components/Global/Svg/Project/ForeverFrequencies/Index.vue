<template>
  <div
    :class="[
      'svg__project__forever-frequencies',
      { 'svg__project__forever-frequencies--animation': animation },
    ]">
    <template v-if="isMobileLayout">
      <Ticker
        ...
        class="svg__project__forever-frequencies__ticker"
        @update="emit('update-scroll')">
        <div v-for="i in 2" :key="i">
          <SvgProjectForeverFrequenciesFirstLine
      ...
      <Ticker
        ...
        @update="emit('update-scroll')">
        <div v-for="i in 2" :key="i">
          <SvgProjectForeverFrequenciesSecondLine
            v-transition:in="{ callback: animation ? shuffleIn : () => {} }" />
        </div>
      </Ticker>
    </template>
...
const id = 'project-ticker-forever-frequencies'
