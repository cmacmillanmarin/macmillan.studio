<template>
  <div
    :class="[
      'svg__project__google-cloud-team-usa',
      { 'svg__project__google-cloud-team-usa--animation': animation },
    ]">
    <template v-if="isMobileLayout">
      <Ticker
        ...
        class="svg__project__google-cloud-team-usa__ticker"
        @update="emit('update-scroll')">
        <div v-for="i in 2" :key="i">
          <SvgProjectGoogleCloudTeamUsaFirstLine
      ...
      <Ticker
        ...
        @update="emit('update-scroll')">
        <div v-for="i in 2" :key="i">
          <SvgProjectGoogleCloudTeamUsaSecondLine
            v-transition:in="{ callback: animation ? shuffleIn : () => {} }" />
        </div>
      </Ticker>
    </template>
...
const id = 'project-ticker-google-cloud-team-usa'
