<template>
  <div :class="['svg__project__gorillaz', { 'svg__project__gorillaz--animation': animation }]">
    <template v-if="isMobileLayout">
      <Ticker
        ...
        class="svg__project__gorillaz__ticker"
        @update="emit('update-scroll')">
        <div v-for="i in 2" :key="i">
          <SvgProjectGorillazFirstLine
...
const id = 'project-ticker-gorillaz'
