<template>
  <div
    :class="[
      'svg__project__carolina-herrera',
      { 'svg__project__carolina-herrera--animation': animation },
    ]">
    <template v-if="isMobileLayout">
      <Ticker
        ...
        class="svg__project__carolina-herrera__ticker"
        @update="emit('update-scroll')">
        <div v-for="i in 2" :key="i">
          <SvgProjectCarolinaHerreraFirstLine
      ...
      <Ticker
        ...
        @update="emit('update-scroll')">
        <div v-for="i in 2" :key="i">
          <SvgProjectCarolinaHerreraSecondLine
            v-transition:in="{ callback: animation ? shuffleIn : () => {} }" />
        </div>
      </Ticker>
    </template>
...
const id = 'project-ticker-carolina-herrera'
