<template>
  <div
    :class="[
      'svg__project__chaos-fashion',
      { 'svg__project__chaos-fashion--animation': animation },
    ]">
    <template v-if="isMobileLayout">
      <SvgProjectChaosFashionFirstLine
      ...
      <Ticker
        ...
        class="svg__project__chaos-fashion__ticker"
        @update="emit('update-scroll')">
        <div v-for="i in 2" :key="i">
          <SvgProjectChaosFashionSecondLine
            v-transition:in="{ callback: animation ? shuffleIn : () => {} }" />
        </div>
      </Ticker>
    </template>
...
const id = 'project-ticker-chaos-fashion'
