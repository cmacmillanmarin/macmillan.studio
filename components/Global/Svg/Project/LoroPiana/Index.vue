<template>
  <div :class="['svg__project__loro-piana', { 'svg__project__loro-piana--animation': animation }]">
    <SvgProjectLoroPianaFirstLine
      v-transition:in="{ callback: animation ? shuffleIn : () => {} }" />
    <SvgProjectLoroPianaSecondLine
      v-transition:in="{ callback: animation ? shuffleIn : () => {} }" />
  </div>
</template>
