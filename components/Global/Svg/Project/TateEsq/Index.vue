<template>
  <div :class="['svg__project__tate-esq', { 'svg__project__tate-esq--animation': animation }]">
    <template v-if="isMobileLayout">
      <Ticker
        ...
        class="svg__project__tate-esq__ticker"
        @update="emit('update-scroll')">
        <div v-for="i in 2" :key="i">
          <SvgProjectTateEsqFirstLine
...
const id = 'project-ticker-tate-esq'
